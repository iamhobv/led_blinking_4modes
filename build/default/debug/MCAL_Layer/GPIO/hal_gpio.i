...
# 1 "MCAL_Layer/GPIO/../std_libarires.h" 1
# 11 "MCAL_Layer/GPIO/../std_libarires.h"
...
# 11 "MCAL_Layer/GPIO/../std_libarires.h" 2
    ...
    else
{
        switch (pin_config->direction){
            case GPIO_DIRECTION_OUTPUT:
                (*tris_reg[pin_config->port] &= ~((uint8)1<<pin_config->pin));
                break;
...
Std_ReturnType gpio_pin_get_direction(const pin_config_t *pin_config, direction_t *direction_status)
{
    ...
    {
        *direction_status = ((*tris_reg[pin_config->direction] >> pin_config->pin) & (uint8)1);
    }
    return ret;
}
...
Std_ReturnType gpio_pin_write_logic(const pin_config_t *pin_config, logic_t logic)
{
    ...
    if (((void*)0) == pin_config || pin_config->pin > 8 - 1) {
        ...
        switch (logic) {
            case GPIO_LOGIC_LOW:
                (*lat_reg[pin_config->port] &= ~((uint8)1<<pin_config->pin));
                break;
...
Std_ReturnType gpio_pin_read_logic(const pin_config_t *pin_config, logic_t *logic)
{
    ...
    {
        *logic = ((*port_reg[pin_config->port] >> pin_config->pin) & (uint8)1);
    }
    return ret;
}
